...
const { PACKAGE_NAME, validateTargetProject, checkPortalCoreDependency, getPortalCoreVersion, runNpmCommand, clearCaches } = require('./package-utils');
...
function main() {
  ...
  console.log('Portal-Core registry restoration started');
  ...
  try {
    ...
    // 2. Check Portal-Core dependency
    ...
    const version = getPortalCoreVersion(packageJson);
